...
export function AuthShell({ mode }: { mode: "login" | "signup" }) {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="container-shell relative py-5 sm:py-6">
        ...
        <div className="mt-8 grid gap-6 lg:min-h-[calc(100vh-7rem)] lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <section className="order-2 lg:order-1">
            <div className="glass-panel noise-overlay relative overflow-hidden rounded-[36px] border-white/65 p-6 sm:p-8 lg:p-10">
              ...
              <div className="relative max-w-xl space-y-8">
                ...
                <div className="space-y-4">
                  <h1 className="font-display text-[2.8rem] font-semibold leading-[0.97] tracking-[-0.05em] text-foreground sm:text-[3.75rem] lg:text-[4.5rem]">
                    {isSignup ? "Start planning with clarity." : "Step back into the day with control."}
                  </h1>
                  <p className="max-w-xl text-base leading-8 text-secondary-foreground sm:text-lg">
                    {isSignup
                ...
                <div className="rounded-[28px] border border-white/70 bg-white/76 px-5 py-5 shadow-[0_18px_46px_rgba(15,23,42,0.05)]">
                  ...
                  {authRows.map((row, index) => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm leading-7 text-secondary-foreground">{row.copy}</p>
                      </div>
                    </div>
                  ))}
                </div>

                <div className="flex flex-wrap gap-2 text-sm text-secondary-foreground">
          ...
          <section className="order-1 lg:order-2">
            <div className="glass-panel fade-in-up relative overflow-hidden rounded-[34px] border-white/70 bg-white/94 p-6 shadow-[0_30px_90px_rgba(15,23,42,0.12)] sm:p-8 lg:p-10">
              ...
              <div className="relative mx-auto max-w-md space-y-6">
                <div className="space-y-3">
                  ...
                  <h2 className="font-display text-3xl font-semibold tracking-tight text-foreground sm:text-[2.2rem]">
